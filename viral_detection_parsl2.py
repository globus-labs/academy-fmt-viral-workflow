...
def run_genomad(unzipped_spades,genomad_output_dir,db):
 ...
 """
    ...
    with open("/xdisk/bhurwitz/virus_hunting/kolodisner/fmt_viruses/viral_detection_pipeline/parsl2.out", "a") as f:
        f.write(start_msg) 
...
def main():
    ...
    for sample_id in sample_ids:
        ...
        genomad_output_dir = os.path.join(config['OUT_GENOMAD_PARSL2'], sample_id)
